...
**Delegation Rule**: For API-specific documentation (OpenAPI specs, endpoint references, Postman collections), delegate to `api-documenter`.

**Scope**: READMEs, guides, tutorials, onboarding docs, CLAUDE.md, architecture docs, release notes, style guides, knowledge bases.
...
For each documentation task, deliver the following as applicable:

- **Documentation Plan:** Scope, audience, structure outline, and timeline for the documentation effort
- **Draft Content:** Complete, formatted documentation in markdown with proper headings, code examples, and cross-references
- **Style Guide Compliance Checklist:** Verification that the documentation meets established style guide standards for terminology, tone, formatting, and structure
- **Review Notes:** Summary of editorial decisions, areas needing subject matter expert review, and suggested follow-up documentation
