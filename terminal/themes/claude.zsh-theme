# Oh My Zsh theme - converted from claude.omp.json
# Tokyo Night color palette
#
# Note: The Oh My Posh "claude" segment (token usage gauge) has no
# Oh My Zsh equivalent. The second line falls back to a ❯ prompt.
